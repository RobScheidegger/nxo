...
namespace NXO.UnitTests.TicTacToe
{
    public class TicTacToeGameLogicTests
    {
        ...
        public void Logic_3x3_GetPositionFromBoardWhere()
        {
            ...
            //Assert
            Assert.Contains(x_paths, i => i.Location[0] == 0 && i.Location[1] == 0);
            Assert.Contains(o_paths, i => i.Location[0] == 1 && i.Location[1] == 1);
            Assert.Contains(o_paths, i => i.Location[0] == 2 && i.Location[1] == 1);
        }
        [Fact]
        public void Logic_3x3_GetPositionFromBoardWhere_Horizontal()
        {
            ...
            //Assert
            Assert.Contains(x_paths, i => i.Location[0] == 2 && i.Location[1] == 1);
            Assert.Contains(x_paths, i => i.Location[0] == 0 && i.Location[1] == 0);
            Assert.Contains(x_paths, i => i.Location[0] == 0 && i.Location[1] == 2);

            Assert.Contains(o_paths, i => i.Location[0] == 1 && i.Location[1] == 0);
            Assert.Contains(o_paths, i => i.Location[0] == 1 && i.Location[1] == 1);
            Assert.Contains(o_paths, i => i.Location[0] == 1 && i.Location[1] == 2);
        }
        [Fact]
